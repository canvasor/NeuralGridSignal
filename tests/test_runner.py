...
from neural_grid_signal.models import Candle, FundingSnapshot, OpenInterestSnapshot, OrderBookSnapshot, SymbolMarketData, TickerSnapshot
...
class FakeNotifier:
    ...
    async def send_strategy_signal(self, strategy, score, strategy_path):
        self.calls.append((strategy, score, strategy_path))
        return None
